...
const ContactPage = () => {
  ...
  didOpen: () => {
    ...
    try {
     ...
     const formSubmitUrl = 'https://formsubmit.co/cvemurielsalbador@gmail.com';
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Estoy aquí para ayudarte. Si tienes alguna consulta, comentario o simplemente quieres charlar, no dudes en contactarme. Estoy a un mensaje de distancia.
        </p>
      </div>
