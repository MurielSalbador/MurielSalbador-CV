...
const socialLinks = [
  {
    ...
    subText: "muriel-salbador",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/muriel-salbador/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@muriel_salbado",
    icon: Instagram,
    url: "https://www.instagram.com/muriel_salbador?igsh=dHp1a2F6ZGxkbjlt",
    color: "#E4405F",
  ...
  
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@MurielSalbador",
    icon: Github,
    url: "https://github.com/MurielSalbador",
    color: "#ffffff",
