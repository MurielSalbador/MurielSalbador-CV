...
INSERT INTO "public"."certificates" ("id", "img", "title", "date") VALUES
	...
	(4, 'http://127.0.0.1:54321/storage/v1/object/public/project-images/bio-robotica.png', 'Diploma - Webinar de Bio-Robótica', '(2024)'),
	(5, 'http://127.0.0.1:54321/storage/v1/object/public/project-images/CERTIFICADO.png', 'Curso de N8N – Creá tu Agente de Inteligencia Artificial', '(2025)');
...
INSERT INTO "public"."projects" ("id", "created_at", "Title", "Description", "Img", "Link", "Github", "Features", "TechStack") VALUES
	...
	(3, '2026-03-31 17:28:16.359251+00', 'Stock AFIP - Depósitos Fiscales', 'Sistema full-stack moderno para gestionar el stock en depósitos fiscales con integración a los servicios de AFIP. Está estructurado como una aplicación web empaquetada para escritorio.', 'http://127.0.0.1:54321/storage/v1/object/public/project-images/AFIP.png', '', '[]', '["Arquitectura de tres capas (Frontend, Aplicación, Datos)", "Ejecución nativa en Windows con Electron", "Integración con servicios SOAP de AFIP", "Visualización de datos con Recharts", "Tareas programadas con Node-cron", "Seguridad con JWT y Bcrypt", "Gestión de migraciones con Prisma"]', '["React 19", "TypeScript", "Vite", "Node.js", "Express 5", "Prisma", "PostgreSQL", "Electron"]');
